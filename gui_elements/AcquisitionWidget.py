...
class PropagatedMaskGridDisplay(QWidget):
    ...
    def display_propagated_mask_grid(self, filtering_cube):
...
class Worker(QThread):
    ...
    def run(self):
        ...
        self.finished_propagate_mask_grid.emit(filtering_cube)  # Emit a tuple of arrays
...
class AcquisitionWidget(QWidget):
    def __init__(self, editor_system_config):
        ...
        self.result_display_widget.addTab(self.camera_result_display, "Mask Grid empty")
        self.result_display_widget.addTab(self.propagated_mask_display, "Propagated Mask Grid")


        # Create the run button
        self.run_button = QPushButton('Fill Mask Grid')
    ...
    @pyqtSlot(np.ndarray)
    def display_propagated_masks(self, filtering_cube):
        self.propagated_mask_display.display_propagated_mask_grid(filtering_cube)
